<template>
  <div id="spaceManagePage">
    ...
    <a-form layout="inline" :model="formData" @finish="handleSubmit">
      ...
      <a-form-item>
        <a-button type="primary" htmlType="submit">添加用户</a-button>
      </a-form-item>
    </a-form>
...
import { SPACE_LEVEL_OPTIONS, SPACE_ROLE_ENUM, SPACE_ROLE_MAP, SPACE_ROLE_OPTIONS } from '@/constants/space.ts'

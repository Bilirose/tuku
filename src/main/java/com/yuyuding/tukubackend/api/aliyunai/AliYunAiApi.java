package com.yuyuding.tukubackend.api.aliyunai;
...
public class AliYunAiApi {
    ...
    public CreateOutPaintingTaskResponse createOutPaintingTask(CreateOutPaintingTaskRequest createOutPaintingTaskRequest) {
        if(createOutPaintingTaskRequest == null) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR,"扩展参数为空");
        }
        // 发送请求
        //https://bailian.console.aliyun.com/?spm=5176.29619931.J__Z58Z6CX7MY__Ll8p1ZOR.1.747c521cW8I2xC&tab=api#/doc/?type=model&url=https%3A%2F%2Fhelp.aliyun.com%2Fdocument_detail%2F2796845.html
        ...
        try(HttpResponse httpResponse =  httpRequest.execute()){
            if(!httpResponse.isOk()) {
                ...
                throw new BusinessException(ErrorCode.PARAMS_ERROR,"AI 扩图失败");
            }
    ...
    public GetOutPaintingTaskResponse getOutPaintingTask(String taskId) {
        ...
        try(HttpResponse httpResponse =  HttpRequest.get(url)
            ...
            if(!httpResponse.isOk()) {
                log.error("请求异常: {}",httpResponse.body());
                throw new BusinessException(ErrorCode.PARAMS_ERROR,"获取任务结果失败");
            }

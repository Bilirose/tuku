package com.yuyuding.tukubackend.manager.websocket;
...
import com.yuyuding.tukubackend.manager.websocket.disruptor.PictureEditEventProducer;
import com.yuyuding.tukubackend.manager.websocket.model.PictureEditActionEnum;
import com.yuyuding.tukubackend.manager.websocket.model.PictureEditMessageTypeEnum;
import com.yuyuding.tukubackend.manager.websocket.model.PictureEditRequestMessage;
import com.yuyuding.tukubackend.manager.websocket.model.PictureEditResponseMessage;
...
public class PictureEditHandler extends TextWebSocketHandler {
    ...
    private void broadcastToPicture(Long pictureId, PictureEditResponseMessage pictureEditResponseMessage, WebSocketSession excludeSession) throws IOException {
        ...
        if (CollUtil.isNotEmpty(sessionSet)) {
            ...
            // 配置序列化：将 Long 类型转换为 String ，解决丢失精度问题

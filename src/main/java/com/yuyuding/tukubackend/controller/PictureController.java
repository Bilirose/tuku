...
import com.yuyuding.tukubackend.api.aliyunai.AliYunAiApi;
import com.yuyuding.tukubackend.api.aliyunai.model.CreateOutPaintingTaskResponse;
import com.yuyuding.tukubackend.api.aliyunai.model.GetOutPaintingTaskResponse;
import com.yuyuding.tukubackend.common.BaseResponse;
import com.yuyuding.tukubackend.common.DeleteRequest;
...
import com.yuyuding.tukubackend.manager.auth.SpaceUserAuthManager;
import com.yuyuding.tukubackend.manager.auth.StpKit;
import com.yuyuding.tukubackend.manager.auth.annotation.SaSpaceCheckPermission;
import com.yuyuding.tukubackend.manager.auth.model.SpaceUserPermissionConstant;
import com.yuyuding.tukubackend.model.dto.picture.*;
import com.yuyuding.tukubackend.model.entity.Picture;
import com.yuyuding.tukubackend.model.entity.Space;
import com.yuyuding.tukubackend.model.entity.User;
import com.yuyuding.tukubackend.model.enums.PictureReviewStatusEnum;
import com.yuyuding.tukubackend.model.vo.PictureTagCategory;
import com.yuyuding.tukubackend.model.vo.PictureVO;
import com.yuyuding.tukubackend.service.PictureService;
import com.yuyuding.tukubackend.service.SpaceService;
import com.yuyuding.tukubackend.service.UserService;
...
//            }
    ...
    public BaseResponse<Page<PictureVO>> listPictureVOByPageWithCache(@RequestBody PictureQueryRequest pictureQueryRequest) {
        ...
        Page<Picture> picturePage = pictureService.page(new Page<>(current, pageSize),
                pictureService.getQueryWrapper(pictureQueryRequest));
        Page<PictureVO> pictureVOByPage = pictureService.getPictureVOByPage(picturePage);
        // 4. 更新缓存
        String catcheValue = JSONUtil.toJsonStr(pictureVOByPage);
        // 更新本地缓存
        LOCAL_CACHE.put(cacheKey, catcheValue);
        // 更新 Redis 缓存
        // 设置缓存的过期时间，5 - 10 分钟过期，防止缓存雪崩
        int cacheExpireTime = 300 + RandomUtil.randomInt(0, 300);
        opsForValue.set(cacheKey, catcheValue, cacheExpireTime, TimeUnit.SECONDS);
        // 获取封装类
    ...
    public BaseResponse<PictureTagCategory> listPictureTagCategory() {
        ...
        List<String> categroyList = Arrays.asList("模版", "电商", "表情包", "素材", "海报");
        pictureTagCategory.setTagList(tagList);
        pictureTagCategory.setCategoryList(categroyList);

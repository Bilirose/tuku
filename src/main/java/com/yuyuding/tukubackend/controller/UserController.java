...
import com.yuyuding.tukubackend.model.dto.user.UserAddRequest;
import com.yuyuding.tukubackend.model.dto.user.UserLoginRequest;
import com.yuyuding.tukubackend.model.dto.user.UserQueryRequest;
import com.yuyuding.tukubackend.model.dto.user.UserRegisterRequest;
...
public class UserController {
    ...
    @PostMapping("/update")
    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
    public BaseResponse<Long> updateUser(UserAddRequest userAddRequest) {
        ThrowUtils.throwIf(userAddRequest == null, ErrorCode.PARAMS_ERROR);
        User user = new User();
        BeanUtils.copyProperties(userAddRequest, user);
        //默认密码
